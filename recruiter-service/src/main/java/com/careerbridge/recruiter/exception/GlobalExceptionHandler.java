package com.careerbridge.recruiter.exception;
...
public class GlobalExceptionHandler {
    ...
    /**
     * A non-numeric X-User-Id/X-User-Org-Id, or an unconvertible path variable (jobId,
     * applicationId, interviewId). Same trap as the handler above:
     * MethodArgumentTypeMismatchException does NOT implement ErrorResponse, so it would otherwise
     * fall through to a 500 for what is purely a malformed client request. Only the parameter name
     * is echoed, never the offending value.
     */
