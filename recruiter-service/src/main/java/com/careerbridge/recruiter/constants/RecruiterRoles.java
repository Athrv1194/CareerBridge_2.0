package com.careerbridge.recruiter.constants;
 ...
 * auth-service adds a seventh role. Same reasoning as student-service's copy of
 * StudentRegisteredEvent declaring role as a String.
 *
 * Private constructor, no instantiation -- matching auth-service's JwtConstants and
 * student-service's SkillConstants.
 */
public final class RecruiterRoles {
