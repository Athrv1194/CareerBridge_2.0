package com.careerbridge.notification.exception;
...
public class GlobalExceptionHandler {
    ...
    /**
     * A non-numeric X-User-Id (or any unconvertible request parameter). Same trap as the handler
     * above: MethodArgumentTypeMismatchException extends TypeMismatchException, which does NOT
     ...
     *
     * Still required even though {notificationId} is a String here -- X-User-Id is a Long, and
     * ai_incident_log.md explicitly predicts this service hitting the same 500.
     */
