package com.careerbridge.organization.exception;
...
public class GlobalExceptionHandler {
    ...
    /**
     * A non-numeric X-User-Id or X-User-Org-Id, or an unconvertible path variable. Same trap as the
     * handler above: MethodArgumentTypeMismatchException extends TypeMismatchException, which does
     * NOT implement ErrorResponse, so it would otherwise fall through to a 500 for what is purely a
    ...
    public ResponseEntity<Map<String, Object>> handleUnexpectedException(Exception ex) {
        ...
        // X-User-Role arrives here as MissingRequestHeaderException, which does implement
        // ErrorResponse and so correctly becomes a 400.
