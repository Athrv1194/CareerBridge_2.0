-- Career Paths
INSERT IGNORE INTO career_paths (name, description, required_skills) VALUES
('Full Stack Developer', 'Builds both frontend and backend of web applications', 'Programming,Database,Web Development'),
('Backend Developer', 'Specializes in server-side logic and APIs', 'Programming,Database,System Design'),
('Frontend Developer', 'Specializes in UI and user experience', 'Web Development,Programming'),
('Data Scientist', 'Analyzes data and builds ML models', 'Machine Learning,Programming,Database'),
('DevOps Engineer', 'Manages infrastructure, CI/CD, and deployments', 'Linux,Docker,Cloud,System Design'),
('Mobile Developer', 'Builds iOS and Android applications', 'Programming,Mobile Development'),
('System Design Engineer', 'Designs scalable distributed systems', 'System Design,Programming,Database');

-- Categories
INSERT IGNORE INTO categories (name, description) VALUES
('Programming Fundamentals', 'Tests core programming concepts and problem solving'),
('Database & SQL', 'Tests relational database design and query skills'),
('Web Development', 'Tests frontend and backend web technologies'),
('System Design', 'Tests ability to design scalable systems'),
('Data Structures & Algorithms', 'Tests DSA knowledge and complexity analysis');

-- Programming Fundamentals Questions (12 questions, will randomly pick 5)
INSERT IGNORE INTO questions (category_id, question_text, order_index) VALUES
((SELECT id FROM categories WHERE name='Programming Fundamentals'), 'What is the difference between stack and heap memory?', 1),
((SELECT id FROM categories WHERE name='Programming Fundamentals'), 'What is polymorphism in object-oriented programming?', 2),
((SELECT id FROM categories WHERE name='Programming Fundamentals'), 'Explain the concept of recursion with an example.', 3),
((SELECT id FROM categories WHERE name='Programming Fundamentals'), 'What is the difference between == and .equals() in Java?', 4),
((SELECT id FROM categories WHERE name='Programming Fundamentals'), 'What are the four pillars of OOP?', 5),
((SELECT id FROM categories WHERE name='Programming Fundamentals'), 'What is a NullPointerException and how do you prevent it?', 6),
((SELECT id FROM categories WHERE name='Programming Fundamentals'), 'What is the difference between abstract class and interface?', 7),
((SELECT id FROM categories WHERE name='Programming Fundamentals'), 'Explain method overloading vs method overriding.', 8),
((SELECT id FROM categories WHERE name='Programming Fundamentals'), 'What is a design pattern? Name 3 common ones.', 9),
((SELECT id FROM categories WHERE name='Programming Fundamentals'), 'What is the difference between checked and unchecked exceptions?', 10),
((SELECT id FROM categories WHERE name='Programming Fundamentals'), 'What is multithreading and what problems can it cause?', 11),
((SELECT id FROM categories WHERE name='Programming Fundamentals'), 'What is the SOLID principle?', 12);

-- Options for Programming Fundamentals questions (4 options each, weights 0-3)
-- Question 1: Stack vs Heap
INSERT IGNORE INTO options (question_id, option_text, weight, order_index) VALUES
...
((SELECT id FROM questions WHERE question_text='What is the difference between stack and heap memory?'), 'They are the same thing with different names', 0, 4);
...
((SELECT id FROM questions WHERE question_text='What is polymorphism in object-oriented programming?'), 'Only method overloading', 1, 4);
...
((SELECT id FROM questions WHERE question_text='Explain the concept of recursion with an example.'), 'A function that runs only once', 0, 4);
...
((SELECT id FROM questions WHERE question_text='What is the difference between == and .equals() in Java?'), '.equals() only works for strings', 1, 4);
...
((SELECT id FROM questions WHERE question_text='What are the four pillars of OOP?'), 'Only Inheritance and Polymorphism', 0, 4);
...
((SELECT id FROM questions WHERE question_text='What is a NullPointerException and how do you prevent it?'), 'Occurs when memory is full', 1, 4);
...
((SELECT id FROM questions WHERE question_text='What is the difference between abstract class and interface?'), 'Abstract class supports multiple inheritance', 2, 4);
...
((SELECT id FROM questions WHERE question_text='Explain method overloading vs method overriding.'), 'Overloading only works with constructors', 1, 4);
...
((SELECT id FROM questions WHERE question_text='What is a design pattern? Name 3 common ones.'), 'Templates for writing classes', 1, 4);
...
((SELECT id FROM questions WHERE question_text='What is the difference between checked and unchecked exceptions?'), 'Checked exceptions extend RuntimeException', 1, 4);
...
((SELECT id FROM questions WHERE question_text='What is multithreading and what problems can it cause?'), 'Only available in C++', 0, 4);
...
((SELECT id FROM questions WHERE question_text='What is the SOLID principle?'), 'A database design principle', 0, 4);

-- Database & SQL Category Questions (10 questions)
INSERT IGNORE INTO questions (category_id, question_text, order_index) VALUES
((SELECT id FROM categories WHERE name='Database & SQL'), 'What is the difference between INNER JOIN and LEFT JOIN?', 1),
((SELECT id FROM categories WHERE name='Database & SQL'), 'What is database normalization?', 2),
((SELECT id FROM categories WHERE name='Database & SQL'), 'What is a primary key vs foreign key?', 3),
((SELECT id FROM categories WHERE name='Database & SQL'), 'What is an index and why is it used?', 4),
((SELECT id FROM categories WHERE name='Database & SQL'), 'What is ACID in databases?', 5),
((SELECT id FROM categories WHERE name='Database & SQL'), 'What is the difference between SQL and NoSQL?', 6),
((SELECT id FROM categories WHERE name='Database & SQL'), 'What is a stored procedure?', 7),
((SELECT id FROM categories WHERE name='Database & SQL'), 'Explain the difference between DELETE, TRUNCATE, and DROP.', 8),
((SELECT id FROM categories WHERE name='Database & SQL'), 'What is a transaction in a database?', 9),
((SELECT id FROM categories WHERE name='Database & SQL'), 'What is database sharding?', 10);
...
((SELECT id FROM questions WHERE question_text='What is the difference between INNER JOIN and LEFT JOIN?'), 'INNER JOIN is slower than LEFT JOIN always', 1, 4);
...
((SELECT id FROM questions WHERE question_text='What is database normalization?'), 'Backing up the database', 0, 4);
...
((SELECT id FROM questions WHERE question_text='What is a primary key vs foreign key?'), 'Primary key can have duplicate values', 0, 4);
...
((SELECT id FROM questions WHERE question_text='What is an index and why is it used?'), 'Only used in NoSQL databases', 0, 4);
...
((SELECT id FROM questions WHERE question_text='What is ACID in databases?'), 'Atomicity and Consistency only', 1, 4);
...
((SELECT id FROM questions WHERE question_text='What is the difference between SQL and NoSQL?'), 'They are interchangeable', 0, 4);
...
((SELECT id FROM questions WHERE question_text='What is a stored procedure?'), 'Only available in Oracle', 0, 4);
...
((SELECT id FROM questions WHERE question_text='Explain the difference between DELETE, TRUNCATE, and DROP.'), 'TRUNCATE can be rolled back', 1, 4);
...
((SELECT id FROM questions WHERE question_text='What is a transaction in a database?'), 'Only used in banking applications', 1, 4);
...
((SELECT id FROM questions WHERE question_text='What is database sharding?'), 'A type of database index', 1, 4);
