package com.careerbridge.mentor.exception;
...
public class GlobalExceptionHandler {
     ...
     *
     * Live from day one here -- this service has five endpoints taking a JSON body.
     */
     ...
     * value.
     *
     * Live from day one here too -- every session and profile endpoint takes a Long path variable.
     */
