package com.careerbridge.assessment.exception;
...
public class GlobalExceptionHandler {
    ...
    /**
     * A non-numeric X-User-Id, {categoryId} or {attemptId}. Same trap as the handler above:
     ...
     * client request. This service has three ways to trigger it, more than any sibling.
     * Only the parameter name is echoed, never the offending value.
     */
